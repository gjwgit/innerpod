...
- Removes the transparency (surface tint) from the bottom `NavigationBar` on the HOME/TEXT/HISTORY tabs, preventing scrollable text from overlapping confusingly beneath it.
