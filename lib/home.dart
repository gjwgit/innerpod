...
//
// Time-stamp: <Friday 2024-11-01 13:36:17 +1100 Graham Williams>
//
...
class HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  Inner Pod is an app for timing meditation sessions and, optionally,
  storing a log of your meditation sessions to your Pod. A session, in fact,
  can be anything.  The app is commonly used for contemplative or silent
  ...
  Visit [Solid Community AU](https://innerpod.solidcommunity.au) to run the app
  online through your browser.

  The concept for the app and images were generated by large language models.
