...
- Instead of manually setting and overriding a text string with 'Version', this imports and utilizes the `version_widget` package. It will format `v{version}` correctly and clicking on it will open the GitHub CHANGELOG.md file.
...
Tapped on the version label in the HOME page and verified it launched the CHANGELOG. Verified package installs effectively and unit tests run flawless.
